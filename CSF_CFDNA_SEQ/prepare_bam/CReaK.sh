...
#CReaK
docker run --rm -v ${home_dir}:${home_dir} -u $UID --memory 500G 31071993/CSF_CFDNA_SEQ:agent /bin/bash -c \
...
docker run --rm -v ${home_dir}:${home_dir} --memory 100G 31071993/CSF_CFDNA_SEQ:bwa_mem2 /bin/bash -c \
